...
<div class="max-w-4xl mx-auto bg-white border border-gray-300 p-8">
    <div class="mb-8 pb-4 border-b border-gray-100 flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold uppercase tracking-tight">Tambah Buku</h1>
            <p class="text-[10px] text-gray-400 uppercase tracking-widest">Input Koleksi Baru</p>
        </div>
        <a href="{{ route('buku.index') }}" class="text-xs font-bold uppercase border-b border-black hover:text-gray-400 hover:border-gray-400 transition-all">Kembali</a>
    </div>
